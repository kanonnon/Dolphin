        ...
        ref.child("competition").observeSingleEvent(of: .value) { snapshot in
            ...
            if let data = snapshot.value as? [String: [String:String]]{
                ...
                for (_, value) in data {
                    ...
                    record.firstRival = value[Record.field.firstRival.rawValue]
                    record.firstRivalTime = value[Record.field.firstRivalTime.rawValue]
                    record.secondRival = value[Record.field.secondRival.rawValue]
                    record.secondRivalTime = value[Record.field.secondRivalTime.rawValue]
