...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let imageView1 = createImageView(x: 0, y: 0, width: self.view.frame.size.width, height: self.view.frame.height, image: "tutorialImage1.PNG")
        scrollView.addSubview(imageView1)
        
        let imageView2 = createImageView(x: self.view.frame.size.width, y: 0, width: self.view.frame.size.width, height: self.view.frame.height, image: "tutorialImage2.PNG")
        scrollView.addSubview(imageView2)
        
        let imageView3 = createImageView(x: self.view.frame.size.width*2, y: 0, width: self.view.frame.size.width, height: self.view.frame.height, image: "tutorialImage3.PNG")
